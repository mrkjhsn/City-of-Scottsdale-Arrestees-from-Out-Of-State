...
from
		(select        -- my first opportunity in SQL to use "case when"
		...
		where [City of Arrestee] not like '%, AZ %' and --AZ arrestees excluded, but additional steps needed below since a number of records included AZ cities without 'AZ'
			  ...
			  [City of Arrestee] not like '%Tempe%' and    --strips out "City of Arrestee" values that only include "Tempe" without AZ at end
